...
| Current role state at `P1` (owner, roles, multisig owners and threshold, proxy admin) | `scripts/rpc_probe.py --call "owner()"` and role/owner reads; proxy track rung 1 | roles are a pinned state |
