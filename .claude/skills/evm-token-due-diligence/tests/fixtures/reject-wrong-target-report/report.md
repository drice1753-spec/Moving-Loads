...
target_address: 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87
target_symbol: SYNTH
primary_pin_id: P1
...
- Target address 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 (EIP-55); runtime code hash 0x2695c1299ec1011eadc3ebb3f4fa4d32c08ac60d601eeac257ac6d373bc53fb7 at P1; proxy status not_proxy.
...
- **F1** (high, proven, token_controls, P1, 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87): At P1 the owner can call mint(address,uint256) without a cap, increasing totalSupply. Evidence: E2, E3, E5.
...
|---|---|---|---|---|---|---|---|
| E1 | rpc_state | 8453 | 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 | P1 | {"block": "0x1312d00", "calls": ["name()", "symbol()", "decimals()", "totalSupply()"], "method": "eth_call"} | ABI string / uint8 / uint256 decode | name, symbol, decimals, totalSupply resolved at P1 |
| E2 | bytecode | 8453 | 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 | P1 | {"block": "0x1312d00", "method": "eth_getCode"} | PUSH4 selector walk + opcode scan (scripts/selector_scan.py) | runtime selectors include mint(address,uint256); no DELEGATECALL/SELFDESTRUCT; no pause/blacklist selectors |
| E3 | rpc_state | 8453 | 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 | P1 | {"block": "0x1312d00", "data": "0x8da5cb5b", "method": "eth_call"} | address decode of owner() return | owner() returns an externally owned account at P1 |
| E4 | rpc_storage | 8453 | 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 | P1 | {"block": "0x1312d00", "method": "eth_getStorageAt", "slots": ["0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc", "0xb53127684a568b3173ae13b9f8a6016e243e63b6e8ee1178d6a717850b5d6103", "0xa3f0ad74e5423aebfd80d3ef4346578335a9a72aeaee59ff6cb3582b35133d50"]} | raw | EIP-1967 implementation/admin/beacon slots are zero at P1 |
| E5 | source_verified | 8453 | 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 | P1 | {"compiler": "solc (version recorded in artifact)", "method": "compile-and-compare"} | compiled runtime bytes equal eth_getCode bytes except metadata hash | verified source corresponds to deployed runtime; mint is onlyOwner with no cap |
...
| E11 | rpc_state | 8453 | 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 | P1 | {"block": "0x1312d00", "calls": ["balanceOf(pool)", "balanceOf(locker)", "balanceOf(treasury)", "balanceOf(holder1)", "totalSupply()"], "method": "eth_call"} | uint256 decode | pool, treasury and top holder balances reconcile to totalSupply within the declared holder threshold |
| E12 | log_decoded | 8453 | 0xE76eEe9B767e85f46778eA6fDf5Cfd20937efB87 | P2 | {"fromBlock": "0x121eac0", "method": "eth_getLogs", "toBlock": "0x121fe48", "topics": ["Transfer(address,address,uint256)"]} | ERC-20 Transfer event | launch-era transfers decoded at P2: initial supply to deployer, then to pool and treasury |
